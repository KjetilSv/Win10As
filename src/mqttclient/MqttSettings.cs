...
namespace mqttclient
{
    public static class MqttSettings
    {
        ...
        public static bool DiskSensor
        {
            ...
            set => Properties.Settings.Default["DiskSensor"] = Convert.ToBoolean(value.ToString());
        }
        public static bool EnableWebCamPublish
        {
            get => (bool)Properties.Settings.Default["EnableWebCamPublish"];
            set => Properties.Settings.Default[nameof(EnableWebCamPublish)] = Convert.ToBoolean(value.ToString());
        }
        ...
        public static Boolean Monitor
        {
            ...
            set => Properties.Settings.Default["CmdMonitor"] = Convert.ToBoolean(value.ToString());
        }
        ...
        public static Boolean Toast
        {
            ...
            set => Properties.Settings.Default["CmdToast"] = Convert.ToBoolean(value.ToString());
        }

        public static Boolean App
        {
            get => (Boolean)Properties.Settings.Default["CmdApp"];
            set => Properties.Settings.Default["CmdApp"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Tts
        {
            get => (Boolean)Properties.Settings.Default["CmdTts"];
            set => Properties.Settings.Default["CmdTts"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Hibernate
        {
            get => (Boolean)Properties.Settings.Default["CmdHibernate"];
            set => Properties.Settings.Default["CmdHibernate"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Shutdown
        {
            get => (Boolean)Properties.Settings.Default["CmdShutdown"];
            set => Properties.Settings.Default["CmdShutdown"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Reboot
        {
            get => (Boolean)Properties.Settings.Default["CmdReboot"];
            set => Properties.Settings.Default["CmdReboot"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Suspend
        {
            get => (Boolean)Properties.Settings.Default["CmdSuspend"];
            set => Properties.Settings.Default["CmdSuspend"] = Convert.ToBoolean(value.ToString());
        }
        public static Boolean Mute
        {
            get => (Boolean)Properties.Settings.Default["CmdMute"];
            set => Properties.Settings.Default["CmdMute"] = Convert.ToBoolean(value.ToString());
        }

        public static Boolean Volume
        {
            get => (Boolean)Properties.Settings.Default["CmdVolume"];
            set => Properties.Settings.Default["CmdVolume"] = Convert.ToBoolean(value.ToString());
        }
